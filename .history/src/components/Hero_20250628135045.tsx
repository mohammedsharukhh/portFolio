...
const Hero: React.FC<HeroProps> = ({ scrollToSection }) => {
  ...
  const text = ['Full Stack Developer', 'UI/UX Designer', 'Problem Solver', 'Tech Enthusiast'];
        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-center space-x-6">
            {[
              ...
              { icon: Mail, href: 'https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRsqHPmJsQcXZMTjgcXKtRdKSTlKpcjFzKRcxsCpRHdzggnxqpbzKGWlpQxZnCpkrcsGQPL', label: 'Email' },
