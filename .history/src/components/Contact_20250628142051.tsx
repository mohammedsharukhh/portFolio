...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Phone',
      value: '+91 8431303150',
      href: 'tel:+91 8431303150',
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Bengaluru',
      href: 'https://www.google.com/maps/place/Bengaluru,+Karnataka/@12.9542802,77.4661281,11z/data=!3m1!4b1!4m6!3m5!1s0x3bae1670c9b44e6d:0xf8dfc3e8517e4fe0!8m2!3d12.9628669!4d77.577509!16zL20vMDljMTc?entry=ttu&g_ep=EgoyMDI1MDYyMy4yIKXMDSoASAFQAw%3D%3D',
    },
  ];
  ...
  const socialLinks = [
    ...
    { icon: Twitter, href: 'https://x.com/msharuk_ms', label: 'Twitter' },
    { icon: MessageSquare, href: 'https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRsqHPmJsQcXZMTjgcXKtRdKSTlKpcjFzKRcxsCpRHdzggnxqpbzKGWlpQxZnCpkrcsGQPL', label: 'Discord' },
  ];
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Mohammed Sharuk M S"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-white/30 transition-colors duration-300"
                    placeholder="sharuk3668@example.com"
                  />
                </div>
              </div>
